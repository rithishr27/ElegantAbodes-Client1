...
const UpdateListing = ()=> {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          setLoading(true);
          setError(false);
          const res = await fetch(`https://elegantabodes-server1.onrender.com/api/listing/updateList/${params.id}`, {
            method: 'POST',
            headers: {
    ...
    return(
        <>
            <main className='p-3 max-w-4xl mx-auto'>
                <h1 className="font-semibold text-3xl text-center my-7 ">Update Your Listing</h1>
